...
GO
:setvar DatabaseName "Orders"
:setvar DefaultFilePrefix "Orders"
:setvar DefaultDataPath "C:\Users\KirstySelesho\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\mssqllocaldb\"
:setvar DefaultLogPath "C:\Users\KirstySelesho\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\mssqllocaldb\"
...
GO
ALTER TABLE [dbo].[Orders]
    ADD DEFAULT GETUTCDATE() FOR [PlacedOn];


GO
PRINT N'Creating Procedure [dbo].[sp_GetOrdersByEmail]...';
